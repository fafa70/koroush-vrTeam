...
Public Class AvoidVictim_Following
    Inherits Motion
    ...
    Protected Overrides Sub OnActivated()
        Console.WriteLine("[AvoidVictim_Following::OnActivated() called")
        MyBase.OnActivated()
        Me._CurrentMovement = Movement.None
    End Sub

    Protected Overrides Sub OnDeActivated()
        Console.WriteLine("[AvoidVictim_Following::OnDeActivated() called")
        ...
        With Me.Control.Agent
            ...
            For Each part As VictimData.VictimPart In current_data.Parts
                ...
                If part.PartName = "chest" Or part.PartName = "head" Or part.PartName = "leg" Or part.PartName = "hand" Then
                    ...
                    Console.WriteLine(String.Format("[AvoidVictim_Following::VictimPart {0} at {1} m", part.PartName, distToPart / 1000))
