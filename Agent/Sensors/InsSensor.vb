...
Public Class InsSensor
    Inherits SingleStateSensor(Of InsData)

    Public Shared ReadOnly SENSORTYPE_INS As String = "INS"

    Public Sub New()
        MyBase.New(New InsData, SENSORTYPE_INS, Sensor.MATCH_ANYNAME)
    ...
    Public Sub Reset(ByVal x As Double, ByVal y As Double, ByVal yaw As Double)
        Me.CurrentData.ResetOffsets(x, y, yaw)
    End Sub
