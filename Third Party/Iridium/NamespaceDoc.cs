...
namespace MathNet.Numerics
{
	...
	///		<see cref="MathNet.Numerics.LinearAlgebra"/>.</li>
	///		<li>A sparse linear algebra package, see
	...
	///		<see cref="MathNet.Numerics.Transformations"/>.</li>
	/// </ul>
	/// </p>
	/// 
	...
	{
		// nothing, for documentation only
	}
}
